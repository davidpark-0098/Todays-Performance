export default function loading(startEnd) {
  if (startEnd === "start") {
    ...
    // 더보기 버튼 아이콘 제거
    document.querySelector("#more_icon").classList.remove("active");
    // 더보기 버튼에서 로딩 시작
    document.querySelector("#loading_icon_on_more_btn").classList.add("active");
    ...
    // 더보기 버튼에서 로딩 종료
    document.querySelector("#loading_icon_on_more_btn").classList.remove("active");
    // 더보기 버튼 아이콘 추가
    document.querySelector("#more_icon").classList.add("active");
  }
}
